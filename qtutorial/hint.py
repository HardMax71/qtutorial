...
class QTutorialHint(QFrame):
    def __init__(self, text, current_step, total_steps, show_step_number=True, parent=None):
        ...
        self.prev_button = create_icon_button("icons:back-button.png")
        self.prev_button.setFocusPolicy(Qt.FocusPolicy.NoFocus)

        self.next_button = create_icon_button("icons:fast-forward.png")
        self.next_button.setFocusPolicy(Qt.FocusPolicy.NoFocus)

        self.stop_button = create_icon_button("icons:close.png")
